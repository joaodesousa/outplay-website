...
export function StoryblokNewsletter() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus('error')
      setMessage(error instanceof Error ? error.message : 'Falha ao subscrever')
    }
  }
      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Mantenha-se à frente da curva</h2>
            <p className="text-gray-400 text-xl">
              Receba os últimos insights, estratégias e sabedoria não convencional na sua caixa de entrada.
            </p>
          </div>
