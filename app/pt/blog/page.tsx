...
export const metadata: Metadata = {
  title: 'Blog | OUTPLAY',
  description: 'Insights, estratégias e estudos de caso sobre como comunicar eficazmente a inovação científica.',
}
  ...
  return (
    <main className="bg-black text-white min-h-screen">
      ...
      <SEO type="website" jsonLd={{
        ...
        '@type': 'Blog',
        'name': 'Blog OUTPLAY',
        'description': 'Insights, perspetivas e estudos de caso sobre branding, design e experiências digitais.',
              ...
              <div className="lg:col-span-5 flex flex-col justify-center">
                <div className="border-l-2 border-white pl-6 mb-4">
                  <span className="text-sm text-gray-400 uppercase tracking-wider">
                    {posts[0].content.tags && posts[0].content.tags.length > 0 ? posts[0].content.tags[0] : "Destaque"}
                  </span>
                </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm font-medium">
                        {posts[0].content.author ? posts[0].content.author.name : "Autor Desconhecido"}
                      </p>
        ...
        <div className="container mx-auto px-6 md:px-12">
          {posts.length <= 1 ? (
            <div className="text-center py-12">
              <p className="text-gray-400">Mais artigos em breve!</p>
            </div>
          ) : (
